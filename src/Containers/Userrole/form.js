...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: UserroleSelectors.getDetailById(state.userrole, id),
    submitFailed: UserroleSelectors.getFormSubmitFailed(state.userrole),
    submitSuccess: UserroleSelectors.getFormSubmitSuccess(state.userrole),
    submit: UserroleSelectors.getFormSubmit(state.userrole),
    submitMessage: UserroleSelectors.getFormSubmitMessage(state.userrole),
    newRecordId: UserroleSelectors.getNewRecordId(state.userrole),
    formData: UserroleSelectors.getForm(state.userrole),
    id,
    redirectPath: '/entity/userrole/update/',
    entityName: 'Userrole',
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(UserroleActions.userroleSetFormValue(data)),
    formReset: (data) => dispatch(UserroleActions.userroleFormReset(data)),
    fetchOne: (query) => dispatch(UserroleActions.userroleRequest(query)),
    entityCreate: (data) => dispatch(UserroleActions.userroleCreate(data)),
    entityUpdate: (data, id) => dispatch(UserroleActions.userroleUpdate(data, id))
  }
}
