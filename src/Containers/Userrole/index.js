...
// const Userrole = LayoutTableData
...
const mapStateToProps = (state, ownProps) => {
  ...
  const allDataArr = UserroleSelectors.getAllDataArr(state.userrole)
  ...
  return {
    ...
    defaultPageSize,
    column,
    maxModifiedon: parseInt(UserroleSelectors.getMaxModifiedon(state.userrole) || 0),
    allDataArr,
    allIds: UserroleSelectors.getAllIds(state.userrole),
    byId: UserroleSelectors.getById(state.userrole),
    entityName: 'Userrole',
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    fetchAll: (query) => dispatch(UserroleActions.userroleRequestAll(query)),
    deleteRow: (query) => dispatch(UserroleActions.userroleDeleteSuccess(query)),
    updateOne: (data, id) => dispatch(UserroleActions.userroleUpdate(data, id)),
    removeOne: (data, id) => dispatch(UserroleActions.userroleRemove(data, id)),
    updateBatch: (data) => dispatch(UserroleActions.userroleUpdateBatch(data))
  }
}
