...
import ProductActions, {ProductSelectors} from './redux'
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: ProductSelectors.getDetailById(state.product, id),
    submitFailed: ProductSelectors.getFormSubmitFailed(state.product),
    submitSuccess: ProductSelectors.getFormSubmitSuccess(state.product),
    submit: ProductSelectors.getFormSubmit(state.product),
    submitMessage: ProductSelectors.getFormSubmitMessage(state.product),
    newRecordId: ProductSelectors.getNewRecordId(state.product),
    formData: ProductSelectors.getForm(state.product),
    id,
    redirectPath: '/entity/product/update/',
    entityName: 'Product',
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(ProductActions.productSetFormValue(data)),
    formReset: (data) => dispatch(ProductActions.productFormReset(data)),
    fetchOne: (query) => dispatch(ProductActions.productRequest(query)),
    entityCreate: (data) => dispatch(ProductActions.productCreate(data)),
    entityUpdate: (data, id) => dispatch(ProductActions.productUpdate(data, id))
  }
}
