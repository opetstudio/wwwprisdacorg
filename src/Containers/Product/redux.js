...
const { Types, Creators } = createActions({
  // C
  productCreate: ['data'],
  productCreateFailed: ['data'],
  productCreateSuccess: ['data'],

  // R
  productRequest: ['data'],
  productRequestAll: ['data'],
  productRequestFailed: ['data'],
  productRequestSuccess: ['data'],

  productRemove: ['data', 'id'],
  productUpdate: ['data', 'id'],
  productUpdateBatch: ['data'],
  productUpdateFailed: ['data'],
  productUpdateSuccess: ['data'],

  productRemoveFailed: ['data'],
  productRemoveSuccess: ['data'],

  productSetFormValue: ['data'],

  productFormReset: ['data'],
  productDeleteSuccess: ['data'],
  productReset: []
})
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.PRODUCT_REQUEST_ALL]: request,
  [Types.PRODUCT_REQUEST_SUCCESS]: requestSuccess,
  [Types.PRODUCT_REQUEST_FAILED]: requestFailed,
  [Types.PRODUCT_DELETE_SUCCESS]: deleteSuccess,

  [Types.PRODUCT_CREATE]: doFormSubmit,
  [Types.PRODUCT_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.PRODUCT_CREATE_FAILED]: doFormSubmitFailed,

  [Types.PRODUCT_FORM_RESET]: doFormReset,
  [Types.PRODUCT_SET_FORM_VALUE]: setFormValue,

  [Types.PRODUCT_UPDATE]: doFormSubmit,
  [Types.PRODUCT_UPDATE_BATCH]: doFormSubmit,
  [Types.PRODUCT_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.PRODUCT_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.PRODUCT_REMOVE]: remove,
  [Types.PRODUCT_REMOVE_SUCCESS]: removeSuccess,
  [Types.PRODUCT_REMOVE_FAILED]: doFormSubmitFailed,
