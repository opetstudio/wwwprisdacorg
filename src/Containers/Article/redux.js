...
const { Types, Creators } = createActions({
  // C
  articleCreate: ['data'],
  articleCreateFailed: ['data'],
  articleCreateSuccess: ['data'],

  // R
  articleRequest: ['data'],
  articleRequestAll: ['data'],
  articleRequestFailed: ['data'],
  articleRequestSuccess: ['data'],

  articleRemove: ['data', 'id'],
  articleUpdate: ['data', 'id'],
  articleUpdateBatch: ['data'],
  articleUpdateFailed: ['data'],
  articleUpdateSuccess: ['data'],

  articleRemoveFailed: ['data'],
  articleRemoveSuccess: ['data'],

  articleSetFormValue: ['data'],

  articleFormReset: ['data'],
  articleDeleteSuccess: ['data'],
  articleReset: []
})
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.ARTICLE_REQUEST_ALL]: request,
  [Types.ARTICLE_REQUEST_SUCCESS]: requestSuccess,
  [Types.ARTICLE_REQUEST_FAILED]: requestFailed,
  [Types.ARTICLE_DELETE_SUCCESS]: deleteSuccess,

  [Types.ARTICLE_CREATE]: doFormSubmit,
  [Types.ARTICLE_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.ARTICLE_CREATE_FAILED]: doFormSubmitFailed,

  [Types.ARTICLE_FORM_RESET]: doFormReset,
  [Types.ARTICLE_SET_FORM_VALUE]: setFormValue,

  [Types.ARTICLE_UPDATE]: doFormSubmit,
  [Types.ARTICLE_UPDATE_BATCH]: doFormSubmit,
  [Types.ARTICLE_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.ARTICLE_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.ARTICLE_REMOVE]: remove,
  [Types.ARTICLE_REMOVE_SUCCESS]: removeSuccess,
  [Types.ARTICLE_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.ARTICLE_RESET]: reset
})
