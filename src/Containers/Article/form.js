...
import ArticleActions, {ArticleSelectors} from './redux'
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: ArticleSelectors.getDetailById(state.article, id),
    submitFailed: ArticleSelectors.getFormSubmitFailed(state.article),
    submitSuccess: ArticleSelectors.getFormSubmitSuccess(state.article),
    submit: ArticleSelectors.getFormSubmit(state.article),
    submitMessage: ArticleSelectors.getFormSubmitMessage(state.article),
    newRecordId: ArticleSelectors.getNewRecordId(state.article),
    formData: ArticleSelectors.getForm(state.article),
    id,
    redirectPath: '/entity/article/update/',
    entityName: 'Article',
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(ArticleActions.articleSetFormValue(data)),
    formReset: (data) => dispatch(ArticleActions.articleFormReset(data)),
    fetchOne: (query) => dispatch(ArticleActions.articleRequest(query)),
    entityCreate: (data) => dispatch(ArticleActions.articleCreate(data)),
    entityUpdate: (data, id) => dispatch(ArticleActions.articleUpdate(data, id))
  }
}
