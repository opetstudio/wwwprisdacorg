...
const { Types, Creators } = createActions({
  // C
  bulletinCreate: ['data'],
  bulletinCreateFailed: ['data'],
  bulletinCreateSuccess: ['data'],

  // R
  bulletinRequest: ['data'],
  bulletinRequestAll: ['data'],
  bulletinRequestFailed: ['data'],
  bulletinRequestSuccess: ['data'],

  bulletinRemove: ['data', 'id'],
  bulletinUpdate: ['data', 'id'],
  bulletinUpdateBatch: ['data'],
  bulletinUpdateFailed: ['data'],
  bulletinUpdateSuccess: ['data'],

  bulletinRemoveFailed: ['data'],
  bulletinRemoveSuccess: ['data'],

  bulletinSetFormValue: ['data'],

  bulletinFormReset: ['data'],
  bulletinDeleteSuccess: ['data'],
  bulletinReset: []
})

export const BulletinTypes = Types
...
export const BulletinSelectors = {
  ...
  getOneById: (state, id) => BulletinSelectors.getById(state)[id],
...
export const reducer = createReducer(INITIAL_STATE, {
  [Types.BULLETIN_REQUEST]: request,
  [Types.BULLETIN_REQUEST_ALL]: request,
  [Types.BULLETIN_REQUEST_SUCCESS]: requestSuccess,
  [Types.BULLETIN_REQUEST_FAILED]: requestFailed,
  [Types.BULLETIN_DELETE_SUCCESS]: deleteSuccess,

  [Types.BULLETIN_CREATE]: doFormSubmit,
  [Types.BULLETIN_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.BULLETIN_CREATE_FAILED]: doFormSubmitFailed,

  [Types.BULLETIN_FORM_RESET]: doFormReset,
  [Types.BULLETIN_SET_FORM_VALUE]: setFormValue,

  [Types.BULLETIN_UPDATE]: doFormSubmit,
  [Types.BULLETIN_UPDATE_BATCH]: doFormSubmit,
  [Types.BULLETIN_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.BULLETIN_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.BULLETIN_REMOVE]: remove,
  [Types.BULLETIN_REMOVE_SUCCESS]: removeSuccess,
  [Types.BULLETIN_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.BULLETIN_RESET]: reset
})
