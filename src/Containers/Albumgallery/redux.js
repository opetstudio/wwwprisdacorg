...
const { Types, Creators } = createActions({
  // C
  albumgalleryCreate: ['data'],
  albumgalleryCreateFailed: ['data'],
  albumgalleryCreateSuccess: ['data'],

  // R
  albumgalleryRequest: ['data'],
  albumgalleryRequestAll: ['data'],
  albumgalleryRequestFailed: ['data'],
  albumgalleryRequestSuccess: ['data'],

  albumgalleryRemove: ['data', 'id'],
  albumgalleryUpdate: ['data', 'id'],
  albumgalleryUpdateBatch: ['data'],
  albumgalleryUpdateFailed: ['data'],
  albumgalleryUpdateSuccess: ['data'],

  albumgalleryRemoveFailed: ['data'],
  albumgalleryRemoveSuccess: ['data'],

  albumgallerySetFormValue: ['data'],

  albumgalleryFormReset: ['data'],
  albumgalleryDeleteSuccess: ['data'],
  albumgalleryReset: []
})

export const AlbumgalleryTypes = Types
...
export const AlbumgallerySelectors = {
...
export const reducer = createReducer(INITIAL_STATE, {
  [Types.ALBUMGALLERY_REQUEST]: request,
  [Types.ALBUMGALLERY_REQUEST_ALL]: request,
  [Types.ALBUMGALLERY_REQUEST_SUCCESS]: requestSuccess,
  [Types.ALBUMGALLERY_REQUEST_FAILED]: requestFailed,
  [Types.ALBUMGALLERY_DELETE_SUCCESS]: deleteSuccess,

  [Types.ALBUMGALLERY_CREATE]: doFormSubmit,
  [Types.ALBUMGALLERY_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.ALBUMGALLERY_CREATE_FAILED]: doFormSubmitFailed,

  [Types.ALBUMGALLERY_FORM_RESET]: doFormReset,
  [Types.ALBUMGALLERY_SET_FORM_VALUE]: setFormValue,

  [Types.ALBUMGALLERY_UPDATE]: doFormSubmit,
  [Types.ALBUMGALLERY_UPDATE_BATCH]: doFormSubmit,
  [Types.ALBUMGALLERY_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.ALBUMGALLERY_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.ALBUMGALLERY_REMOVE]: remove,
  [Types.ALBUMGALLERY_REMOVE_SUCCESS]: removeSuccess,
  [Types.ALBUMGALLERY_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.ALBUMGALLERY_RESET]: reset
})
