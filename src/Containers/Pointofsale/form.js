...
import PointofsaleActions, {PointofsaleSelectors} from './redux'
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: PointofsaleSelectors.getDetailById(state.pointofsale, id),
    submitFailed: PointofsaleSelectors.getFormSubmitFailed(state.pointofsale),
    submitSuccess: PointofsaleSelectors.getFormSubmitSuccess(state.pointofsale),
    submit: PointofsaleSelectors.getFormSubmit(state.pointofsale),
    submitMessage: PointofsaleSelectors.getFormSubmitMessage(state.pointofsale),
    newRecordId: PointofsaleSelectors.getNewRecordId(state.pointofsale),
    formData: PointofsaleSelectors.getForm(state.pointofsale),
    id,
    redirectPath: '/entity/pointofsale/update/',
    entityName: 'Pointofsale',
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(PointofsaleActions.pointofsaleSetFormValue(data)),
    formReset: (data) => dispatch(PointofsaleActions.pointofsaleFormReset(data)),
    fetchOne: (query) => dispatch(PointofsaleActions.pointofsaleRequest(query)),
    entityCreate: (data) => dispatch(PointofsaleActions.pointofsaleCreate(data)),
    entityUpdate: (data, id) => dispatch(PointofsaleActions.pointofsaleUpdate(data, id))
  }
}
