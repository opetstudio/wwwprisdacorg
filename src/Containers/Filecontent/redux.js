...
const { Types, Creators } = createActions({
  // C
  filecontentCreate: ['data'],
  filecontentCreateFailed: ['data'],
  filecontentCreateSuccess: ['data'],

  // R
  filecontentRequest: ['data'],
  filecontentRequestAll: ['data'],
  filecontentRequestFailed: ['data'],
  filecontentRequestSuccess: ['data'],

  filecontentRemove: ['data', 'id'],
  filecontentUpdate: ['data', 'id'],
  filecontentUpdateBatch: ['data'],
  filecontentUpdateFailed: ['data'],
  filecontentUpdateSuccess: ['data'],

  filecontentRemoveFailed: ['data'],
  filecontentRemoveSuccess: ['data'],

  filecontentSetFormValue: ['data'],

  filecontentFormReset: ['data'],
  filecontentDeleteSuccess: ['data'],
  filecontentReset: []
})

export const FilecontentTypes = Types
...
export const FilecontentSelectors = {
...
export const reducer = createReducer(INITIAL_STATE, {
  [Types.FILECONTENT_REQUEST]: request,
  [Types.FILECONTENT_REQUEST_ALL]: request,
  [Types.FILECONTENT_REQUEST_SUCCESS]: requestSuccess,
  [Types.FILECONTENT_REQUEST_FAILED]: requestFailed,
  [Types.FILECONTENT_DELETE_SUCCESS]: deleteSuccess,

  [Types.FILECONTENT_CREATE]: doFormSubmit,
  [Types.FILECONTENT_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.FILECONTENT_CREATE_FAILED]: doFormSubmitFailed,

  [Types.FILECONTENT_FORM_RESET]: doFormReset,
  [Types.FILECONTENT_SET_FORM_VALUE]: setFormValue,

  [Types.FILECONTENT_UPDATE]: doFormSubmit,
  [Types.FILECONTENT_UPDATE_BATCH]: doFormSubmit,
  [Types.FILECONTENT_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.FILECONTENT_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.FILECONTENT_REMOVE]: remove,
  [Types.FILECONTENT_REMOVE_SUCCESS]: removeSuccess,
  [Types.FILECONTENT_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.FILECONTENT_RESET]: reset
})
