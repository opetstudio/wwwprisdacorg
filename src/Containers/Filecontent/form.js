...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: FilecontentSelectors.getDetailById(state.filecontent, id),
    submitFailed: FilecontentSelectors.getFormSubmitFailed(state.filecontent),
    submitSuccess: FilecontentSelectors.getFormSubmitSuccess(state.filecontent),
    submit: FilecontentSelectors.getFormSubmit(state.filecontent),
    submitMessage: FilecontentSelectors.getFormSubmitMessage(state.filecontent),
    newRecordId: FilecontentSelectors.getNewRecordId(state.filecontent),
    formData: FilecontentSelectors.getForm(state.filecontent),
    id,
    redirectPath: '/entity/filecontent/update/',
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    setFormValue: data =>
      dispatch(FilecontentActions.filecontentSetFormValue(data)),
    formReset: data => dispatch(FilecontentActions.filecontentFormReset(data)),
    fetchOne: query => dispatch(FilecontentActions.filecontentRequest(query)),
    entityCreate: data => dispatch(FilecontentActions.filecontentCreate(data)),
