...
const { Types, Creators } = createActions({
  // C
  galleryCreate: ['data'],
  galleryCreateFailed: ['data'],
  galleryCreateSuccess: ['data'],

  // R
  galleryRequest: ['data'],
  galleryRequestAll: ['data'],
  galleryRequestFailed: ['data'],
  galleryRequestSuccess: ['data'],

  galleryRemove: ['data', 'id'],
  galleryUpdate: ['data', 'id'],
  galleryUpdateBatch: ['data'],
  galleryUpdateFailed: ['data'],
  galleryUpdateSuccess: ['data'],

  galleryRemoveFailed: ['data'],
  galleryRemoveSuccess: ['data'],

  gallerySetFormValue: ['data'],

  galleryFormReset: ['data'],
  galleryDeleteSuccess: ['data'],
  galleryReset: []
})
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.GALLERY_REQUEST_ALL]: request,
  [Types.GALLERY_REQUEST_SUCCESS]: requestSuccess,
  [Types.GALLERY_REQUEST_FAILED]: requestFailed,
  [Types.GALLERY_DELETE_SUCCESS]: deleteSuccess,

  [Types.GALLERY_CREATE]: doFormSubmit,
  [Types.GALLERY_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.GALLERY_CREATE_FAILED]: doFormSubmitFailed,

  [Types.GALLERY_FORM_RESET]: doFormReset,
  [Types.GALLERY_SET_FORM_VALUE]: setFormValue,

  [Types.GALLERY_UPDATE]: doFormSubmit,
  [Types.GALLERY_UPDATE_BATCH]: doFormSubmit,
  [Types.GALLERY_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.GALLERY_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.GALLERY_REMOVE]: remove,
  [Types.GALLERY_REMOVE_SUCCESS]: removeSuccess,
  [Types.GALLERY_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.GALLERY_RESET]: reset
})
