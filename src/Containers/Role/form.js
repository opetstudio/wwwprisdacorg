...
import RoleActions, {RoleSelectors} from './redux'
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: RoleSelectors.getDetailById(state.role, id),
    submitFailed: RoleSelectors.getFormSubmitFailed(state.role),
    submitSuccess: RoleSelectors.getFormSubmitSuccess(state.role),
    submit: RoleSelectors.getFormSubmit(state.role),
    submitMessage: RoleSelectors.getFormSubmitMessage(state.role),
    newRecordId: RoleSelectors.getNewRecordId(state.role),
    formData: RoleSelectors.getForm(state.role),
    id,
    redirectPath: '/entity/role/update/',
    entityName: 'Role',
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(RoleActions.roleSetFormValue(data)),
    formReset: (data) => dispatch(RoleActions.roleFormReset(data)),
    fetchOne: (query) => dispatch(RoleActions.roleRequest(query)),
    entityCreate: (data) => dispatch(RoleActions.roleCreate(data)),
    entityUpdate: (data, id) => dispatch(RoleActions.roleUpdate(data, id))
  }
}
