...
const { Types, Creators } = createActions({
  // C
  roleCreate: ['data'],
  roleCreateFailed: ['data'],
  roleCreateSuccess: ['data'],

  // R
  roleRequest: ['data'],
  roleRequestAll: ['data'],
  roleRequestFailed: ['data'],
  roleRequestSuccess: ['data'],

  roleRemove: ['data', 'id'],
  roleUpdate: ['data', 'id'],
  roleUpdateBatch: ['data'],
  roleUpdateFailed: ['data'],
  roleUpdateSuccess: ['data'],

  roleRemoveFailed: ['data'],
  roleRemoveSuccess: ['data'],

  roleSetFormValue: ['data'],
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.ROLE_REQUEST_ALL]: request,
  [Types.ROLE_REQUEST_SUCCESS]: requestSuccess,
  [Types.ROLE_REQUEST_FAILED]: requestFailed,
  [Types.ROLE_DELETE_SUCCESS]: deleteSuccess,

  [Types.ROLE_CREATE]: doFormSubmit,
  [Types.ROLE_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.ROLE_CREATE_FAILED]: doFormSubmitFailed,

  [Types.ROLE_FORM_RESET]: doFormReset,
  [Types.ROLE_SET_FORM_VALUE]: setFormValue,

  [Types.ROLE_UPDATE]: doFormSubmit,
  [Types.ROLE_UPDATE_BATCH]: doFormSubmit,
  [Types.ROLE_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.ROLE_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.ROLE_REMOVE]: remove,
  [Types.ROLE_REMOVE_SUCCESS]: removeSuccess,
  [Types.ROLE_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.ROLE_RESET]: reset
})
