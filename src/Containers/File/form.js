...
const mapStateToProps = (state, ownProps) => {
  ...
  const dataDetail = FileSelectors.getDetailById(state.file, id) || {}
  // console.log('=======dataDetail=', dataDetail)
  return {
    // ignite boilerplate state list
    column,
    dataDetail: dataDetail,
    submitFailed: FileSelectors.getFormSubmitFailed(state.file),
    submitSuccess: FileSelectors.getFormSubmitSuccess(state.file),
    submit: FileSelectors.getFormSubmit(state.file),
    submitMessage: FileSelectors.getFormSubmitMessage(state.file),
    newRecordId: FileSelectors.getNewRecordId(state.file),
    formData: FileSelectors.getForm(state.file),
    id,
    redirectPath: '/entity/file/update/',
    entityName: 'File',
