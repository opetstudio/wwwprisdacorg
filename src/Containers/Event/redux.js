...
const { Types, Creators } = createActions({
  // C
  eventCreate: ['data'],
  eventCreateFailed: ['data'],
  eventCreateSuccess: ['data'],

  // R
  eventRequest: ['data'],
  eventRequestAll: ['data'],
  eventRequestFailed: ['data'],
  eventRequestSuccess: ['data'],

  eventRemove: ['data', 'id'],
  eventUpdate: ['data', 'id'],
  eventUpdateBatch: ['data'],
  eventUpdateFailed: ['data'],
  eventUpdateSuccess: ['data'],

  eventRemoveFailed: ['data'],
  eventRemoveSuccess: ['data'],

  eventSetFormValue: ['data'],
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.EVENT_REQUEST_ALL]: request,
  [Types.EVENT_REQUEST_SUCCESS]: requestSuccess,
  [Types.EVENT_REQUEST_FAILED]: requestFailed,
  [Types.EVENT_DELETE_SUCCESS]: deleteSuccess,

  [Types.EVENT_CREATE]: doFormSubmit,
  [Types.EVENT_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.EVENT_CREATE_FAILED]: doFormSubmitFailed,

  [Types.EVENT_FORM_RESET]: doFormReset,
  [Types.EVENT_SET_FORM_VALUE]: setFormValue,

  [Types.EVENT_UPDATE]: doFormSubmit,
  [Types.EVENT_UPDATE_BATCH]: doFormSubmit,
  [Types.EVENT_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.EVENT_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.EVENT_REMOVE]: remove,
  [Types.EVENT_REMOVE_SUCCESS]: removeSuccess,
  [Types.EVENT_REMOVE_FAILED]: doFormSubmitFailed,
