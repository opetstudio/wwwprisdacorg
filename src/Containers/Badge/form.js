...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: BadgeSelectors.getDetailById(state.badge, id),
    submitFailed: BadgeSelectors.getFormSubmitFailed(state.badge),
    submitSuccess: BadgeSelectors.getFormSubmitSuccess(state.badge),
    submit: BadgeSelectors.getFormSubmit(state.badge),
    submitMessage: BadgeSelectors.getFormSubmitMessage(state.badge),
    newRecordId: BadgeSelectors.getNewRecordId(state.badge),
    formData: BadgeSelectors.getForm(state.badge),
    id,
    redirectPath: '/entity/badge/update/',
    entityName: 'Badge',
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    setFormValue: data => dispatch(BadgeActions.badgeSetFormValue(data)),
    formReset: data => dispatch(BadgeActions.badgeFormReset(data)),
    fetchOne: query => dispatch(BadgeActions.badgeRequest(query)),
    entityCreate: data => dispatch(BadgeActions.badgeCreate(data)),
    entityUpdate: (data, id) => dispatch(BadgeActions.badgeUpdate(data, id))
  }
}
