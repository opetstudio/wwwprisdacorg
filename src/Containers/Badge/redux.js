...
const { Types, Creators } = createActions({
  // C
  badgeCreate: ['data'],
  badgeCreateFailed: ['data'],
  badgeCreateSuccess: ['data'],

  // R
  badgeRequest: ['data'],
  badgeRequestAll: ['data'],
  badgeRequestFailed: ['data'],
  badgeRequestSuccess: ['data'],

  badgeRemove: ['data', 'id'],
  badgeUpdate: ['data', 'id'],
  badgeUpdateBatch: ['data'],
  badgeUpdateFailed: ['data'],
  badgeUpdateSuccess: ['data'],

  badgeRemoveFailed: ['data'],
  badgeRemoveSuccess: ['data'],

  badgeSetFormValue: ['data'],

  badgeFormReset: ['data'],
  badgeDeleteSuccess: ['data'],
  badgeReset: []
})

export const BadgeTypes = Types
...
export const BadgeSelectors = {
  ...
  getBadgeNumberById: state => {
    return id => {
      let dataDetail = state.byId[id] || {}
      return dataDetail.badge_number
    }
  },
...
export const reducer = createReducer(INITIAL_STATE, {
  [Types.BADGE_REQUEST]: request,
  [Types.BADGE_REQUEST_ALL]: request,
  [Types.BADGE_REQUEST_SUCCESS]: requestSuccess,
  [Types.BADGE_REQUEST_FAILED]: requestFailed,
  [Types.BADGE_DELETE_SUCCESS]: deleteSuccess,

  [Types.BADGE_CREATE]: doFormSubmit,
  [Types.BADGE_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.BADGE_CREATE_FAILED]: doFormSubmitFailed,

  [Types.BADGE_FORM_RESET]: doFormReset,
  [Types.BADGE_SET_FORM_VALUE]: setFormValue,

  [Types.BADGE_UPDATE]: doFormSubmit,
  [Types.BADGE_UPDATE_BATCH]: doFormSubmit,
  [Types.BADGE_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.BADGE_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.BADGE_REMOVE]: remove,
  [Types.BADGE_REMOVE_SUCCESS]: removeSuccess,
  [Types.BADGE_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.BADGE_RESET]: reset
})
