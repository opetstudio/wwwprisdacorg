...
const { Types, Creators } = createActions({
  // C
  participantbadgeCreate: ['data'],
  participantbadgeCreateFailed: ['data'],
  participantbadgeCreateSuccess: ['data'],

  // R
  participantbadgeRequest: ['data'],
  participantbadgeRequestAll: ['data'],
  participantbadgeRequestFailed: ['data'],
  participantbadgeRequestSuccess: ['data'],

  participantbadgeRemove: ['data', 'id'],
  participantbadgeUpdate: ['data', 'id'],
  participantbadgeUpdateBatch: ['data'],
  participantbadgeUpdateFailed: ['data'],
  participantbadgeUpdateSuccess: ['data'],

  participantbadgeRemoveFailed: ['data'],
  participantbadgeRemoveSuccess: ['data'],

  participantbadgeSetFormValue: ['data'],

  participantbadgeFormReset: ['data'],
  participantbadgeDeleteSuccess: ['data'],
  participantbadgeReset: []
})

export const ParticipantbadgeTypes = Types
...
export const ParticipantbadgeSelectors = {
...
export const reducer = createReducer(INITIAL_STATE, {
  [Types.PARTICIPANTBADGE_REQUEST]: request,
  [Types.PARTICIPANTBADGE_REQUEST_ALL]: request,
  [Types.PARTICIPANTBADGE_REQUEST_SUCCESS]: requestSuccess,
  [Types.PARTICIPANTBADGE_REQUEST_FAILED]: requestFailed,
  [Types.PARTICIPANTBADGE_DELETE_SUCCESS]: deleteSuccess,

  [Types.PARTICIPANTBADGE_CREATE]: doFormSubmit,
  [Types.PARTICIPANTBADGE_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.PARTICIPANTBADGE_CREATE_FAILED]: doFormSubmitFailed,

  [Types.PARTICIPANTBADGE_FORM_RESET]: doFormReset,
  [Types.PARTICIPANTBADGE_SET_FORM_VALUE]: setFormValue,

  [Types.PARTICIPANTBADGE_UPDATE]: doFormSubmit,
  [Types.PARTICIPANTBADGE_UPDATE_BATCH]: doFormSubmit,
  [Types.PARTICIPANTBADGE_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.PARTICIPANTBADGE_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.PARTICIPANTBADGE_REMOVE]: remove,
  [Types.PARTICIPANTBADGE_REMOVE_SUCCESS]: removeSuccess,
  [Types.PARTICIPANTBADGE_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.PARTICIPANTBADGE_RESET]: reset
})
