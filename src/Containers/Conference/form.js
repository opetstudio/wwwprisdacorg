...
const mapStateToProps = (state, ownProps) => {
  ...
  const dataDetail = ConferenceSelectors.getDetailById(state.conference, id)
  ...
  return {
    ...
    column,
    dataDetail,
    submitFailed: ConferenceSelectors.getFormSubmitFailed(state.conference),
    submitSuccess: ConferenceSelectors.getFormSubmitSuccess(state.conference),
    submit: ConferenceSelectors.getFormSubmit(state.conference),
    submitMessage: ConferenceSelectors.getFormSubmitMessage(state.conference),
    newRecordId: ConferenceSelectors.getNewRecordId(state.conference),
    formData: ConferenceSelectors.getForm(state.conference),
    id,
    redirectPath: '/entity/conference/update/',
    // allDataArr: makeData(),
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    setFormValue: data =>
      dispatch(ConferenceActions.conferenceSetFormValue(data)),
    formReset: data => dispatch(ConferenceActions.conferenceFormReset(data)),
    fetchOne: query => dispatch(ConferenceActions.conferenceRequest(query)),
    entityCreate: data => dispatch(ConferenceActions.conferenceCreate(data)),
