...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    column,
    dataDetail: NewsSelectors.getDetailById(state.news, id),
    submitFailed: NewsSelectors.getFormSubmitFailed(state.news),
    submitSuccess: NewsSelectors.getFormSubmitSuccess(state.news),
    submit: NewsSelectors.getFormSubmit(state.news),
    submitMessage: NewsSelectors.getFormSubmitMessage(state.news),
    newRecordId: NewsSelectors.getNewRecordId(state.news),
    formData: NewsSelectors.getForm(state.news),
    id,
    redirectPath: '/entity/news/update/',
    entityName: 'News',
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(NewsActions.newsSetFormValue(data)),
    formReset: (data) => dispatch(NewsActions.newsFormReset(data)),
    fetchOne: (query) => dispatch(NewsActions.newsRequest(query)),
    entityCreate: (data) => dispatch(NewsActions.newsCreate(data)),
    entityUpdate: (data, id) => dispatch(NewsActions.newsUpdate(data, id))
  }
}
