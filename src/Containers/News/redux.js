...
const { Types, Creators } = createActions({
  // C
  newsCreate: ['data'],
  newsCreateFailed: ['data'],
  newsCreateSuccess: ['data'],

  // R
  newsRequest: ['data'],
  newsRequestAll: ['data'],
  newsRequestFailed: ['data'],
  newsRequestSuccess: ['data'],

  newsRemove: ['data', 'id'],
  newsUpdate: ['data', 'id'],
  newsUpdateBatch: ['data'],
  newsUpdateFailed: ['data'],
  newsUpdateSuccess: ['data'],

  newsRemoveFailed: ['data'],
  newsRemoveSuccess: ['data'],

  newsSetFormValue: ['data'],

  newsFormReset: ['data'],
  newsDeleteSuccess: ['data'],
  newsReset: []
})
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.NEWS_REQUEST_ALL]: request,
  [Types.NEWS_REQUEST_SUCCESS]: requestSuccess,
  [Types.NEWS_REQUEST_FAILED]: requestFailed,
  [Types.NEWS_DELETE_SUCCESS]: deleteSuccess,

  [Types.NEWS_CREATE]: doFormSubmit,
  [Types.NEWS_CREATE_SUCCESS]: doFormSubmitSuccess,
  [Types.NEWS_CREATE_FAILED]: doFormSubmitFailed,

  [Types.NEWS_FORM_RESET]: doFormReset,
  [Types.NEWS_SET_FORM_VALUE]: setFormValue,

  [Types.NEWS_UPDATE]: doFormSubmit,
  [Types.NEWS_UPDATE_BATCH]: doFormSubmit,
  [Types.NEWS_UPDATE_SUCCESS]: doFormSubmitSuccess,
  [Types.NEWS_UPDATE_FAILED]: doFormSubmitFailed,

  [Types.NEWS_REMOVE]: remove,
  [Types.NEWS_REMOVE_SUCCESS]: removeSuccess,
  [Types.NEWS_REMOVE_FAILED]: doFormSubmitFailed,
  [Types.NEWS_RESET]: reset
})
